...
func Get_api_statesmediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/states%s", cfg.BaseURL, mediaTypeExtension)
...
func CreateGet_api_statesmediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_statesmediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_statesmediatypeextensionHandler(cfg),
	}
}
