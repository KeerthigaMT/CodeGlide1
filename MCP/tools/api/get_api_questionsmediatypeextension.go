...
func Get_api_questionsmediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/questions%s", cfg.BaseURL, mediaTypeExtension)
...
func CreateGet_api_questionsmediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_questionsmediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_questionsmediatypeextensionHandler(cfg),
	}
}
