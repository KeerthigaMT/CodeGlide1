...
func Get_api_topicsmediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/topics%s", cfg.BaseURL, mediaTypeExtension)
...
func CreateGet_api_topicsmediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_topicsmediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_topicsmediatypeextensionHandler(cfg),
	}
}
