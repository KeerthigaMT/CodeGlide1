...
func Get_api_articlesmediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/articles%s", cfg.BaseURL, mediaTypeExtension)
...
func CreateGet_api_articlesmediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_articlesmediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_articlesmediatypeextensionHandler(cfg),
	}
}
