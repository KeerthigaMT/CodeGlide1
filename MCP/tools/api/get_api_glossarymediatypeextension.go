...
func Get_api_glossarymediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/glossary%s", cfg.BaseURL, mediaTypeExtension)
...
func CreateGet_api_glossarymediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_glossarymediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_glossarymediatypeextensionHandler(cfg),
	}
}
