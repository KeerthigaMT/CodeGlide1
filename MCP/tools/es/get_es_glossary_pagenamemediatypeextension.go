...
func Get_es_glossary_pagenamemediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/es/glossary/%s%s", cfg.BaseURL, mediaTypeExtension, pageName)
...
func CreateGet_es_glossary_pagenamemediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_es_glossary_pageNamemediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_es_glossary_pagenamemediatypeextensionHandler(cfg),
	}
}
