...
func Get_es_statenamemediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/es/%s%s", cfg.BaseURL, mediaTypeExtension, stateName)
...
func CreateGet_es_statenamemediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_es_stateNamemediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_es_statenamemediatypeextensionHandler(cfg),
	}
}
