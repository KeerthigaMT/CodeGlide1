...
func Get_es_question_pagenamemediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/es/question/%s%s", cfg.BaseURL, mediaTypeExtension, pageName)
...
func CreateGet_es_question_pagenamemediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_es_question_pageNamemediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_es_question_pagenamemediatypeextensionHandler(cfg),
	}
}
