...
func Get_pagenamemediatypeextensionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/%s%s", cfg.BaseURL, mediaTypeExtension, pageName)
...
func CreateGet_pagenamemediatypeextensionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pageNamemediaTypeExtension",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_pagenamemediatypeextensionHandler(cfg),
	}
}
